 ...
 * Domicilio
 *
 * @ORM\Table(name="domicilio", indexes={@ORM\Index(name="domicilio-localidad_idx", columns={"id_localidad"}), @ORM\Index(name="domicilio-provincia_idx", columns={"id_provincia"})})
 * @ORM\Entity
 */
class Domicilio
{
