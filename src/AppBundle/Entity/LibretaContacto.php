 ...
 * LibretaContacto
 *
 * @ORM\Table(name="libreta_contacto", indexes={@ORM\Index(name="libreta-contacto_idx", columns={"id_tcontacto"}), @ORM\Index(name="libreta-domicilio_idx", columns={"id_domicilio"})})
 * @ORM\Entity
 */
